ALTER TABLE "goal_ompletions" RENAME TO "goal_completions";--> statement-breakpoint
ALTER TABLE "goal_completions" DROP CONSTRAINT "goal_ompletions_goal_id_goals_id_fk";
